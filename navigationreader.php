  ...
  <tr>
    <td height="33" align="right" background="Images/scantop.png" bgcolor="#FD9C11"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="70%" align="right"><a href="readerindex.php" class="a1">首页</a> ┊
        <a  href="readerhistory.php" class="a1">历史记录</a> ┊ 
        <a  href="pwd_readerchange.php" class="a1">个人信息</a> ┊ <a href="safequit.php" class="a1">注销</a></td>
        <td width="2%">&nbsp;</td>
      </tr>
    </table></td>
  </tr>
