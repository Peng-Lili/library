  ...
  <tr>
    <td height="510" valign="top" style="padding:5px;"><table width="98%"  border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		$query=mysql_query("select book.barcode,book.id as bookid,bt.typename,pb.pubname,book.bookname,bc.name 
				from tb_bookinfo book 
				join tb_booktype bt on book.typeid=bt.id 
				join tb_publishing pb on book.ISBM=pb.ISBN 
