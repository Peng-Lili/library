...
<link href="css/style.css" rel="stylesheet">
		...
		function checkreader(form){
			if(form.id.value==""){
				alert("请输入读者id!");form.id.focus();return false;
			}
			form.submit();
		}
...
<table width="776"  border="0" cellspacing="0" cellpadding="0" align="center">
                      ...
                      <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <table width="100%" height="21" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            &nbsp;
                              <input name="Button" type="submit" class="btn_grey" value="确定" onClick="checkreader(form1)"></td>
                          </tr>
                      </table></td>
                    </tr>
                    <tr>
  ...
  <input name="inputkey" type="text" id="inputkey" size="50">
                     <input name="Submit" type="submit" class="btn_grey" id="Submit" onClick="checkbook(form1);" value="确定">
