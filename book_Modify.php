...
<table width="776" border="0" align="center" cellpadding="0" cellspacing="0" class="tableBorder">
  ...
  <tr>
	...
	$sql=mysql_query("select book.barcode,book.id as bookid,book.bookname,bt.typename,book.typeid,book.author,book.ISBM,book.translator,book.bookcase,pb.pubname,book.price,book.page,bc.name from tb_bookinfo book join tb_booktype bt on book.typeid=bt.id join tb_publishing pb on book.ISBM=pb.ISBN join tb_bookcase bc on book.bookcase=bc.id where book.id=$_GET[id]");
