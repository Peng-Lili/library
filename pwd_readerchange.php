...
<table width="778" border="0" align="center" cellpadding="0" cellspacing="0" class="tableBorder">
  ...
  <tr>
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="22" valign="top" class="word_orange">当前位置：读者系统 &gt; 个人信息更改 &gt;&gt;</td>
      </tr>
      <tr>
...
<?php 
  include("conn/conn.php");
	$query=mysql_query("select * from tb_reader where name='$_SESSION[admin_name]'");
...
?>
    ...
    <td align="center" valign="top">	<form name="form1" method="post" action="reader_modifyok.php">
      <table width="600" height="432"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">       
        ...
        <tr>
          <td width="173" align="center">读者id：</td>
          <td width="427" height="39">
            <input name="name" type="text" readonly="yes" value="<?php echo $result[id];?>"readonly='yes'></td>
        </tr>
        <tr>
          <td align="center">读者姓名：</td>
          <td><input name="name" type="text" id="name"  value="<?php echo $_SESSION[admin_name];?>"></td>
        </tr>
        <tr>
        ...
        * </td>
        ...
        <tr>
          ...
          <td><input name="code" type="text" id="code" value="<?php echo $result[pwd];?>"></td>
        </tr>
        <tr>
          <td align="center">&nbsp;</td>
